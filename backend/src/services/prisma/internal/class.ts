...
const config: runtime.GetPrismaClientConfig = {
  "generator": {
    ...
    "output": {
      "value": "/mnt/c/Users/Chrono/repos/my-fullstack-app/backend/src/services/prisma",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
    ...
    "previewFeatures": [],
    "sourceFilePath": "/mnt/c/Users/Chrono/repos/my-fullstack-app/backend/prisma/schema.prisma",
    "isCustomOutput": true
  },
  "relativePath": "../../../prisma",
  ...
  "inlineDatasources": {
    "db": {
      "url": {
        "fromEnvVar": null,
        "value": "postgresql://chrono@localhost:5432/postgres"
      }
    }
  },
  "inlineSchema": "datasource db {\n  provider = \"postgresql\"\n  url      = \"postgresql://chrono@localhost:5432/postgres\"\n}\n\ngenerator client {\n  provider = \"prisma-client\"\n  output   = \"../src/services/prisma\"\n}\n\nmodel User {\n  id        Int      @id @default(autoincrement())\n  name      String\n  email     String   @unique\n  createdAt DateTime @default(now())\n  updatedAt DateTime @updatedAt\n  Post      Post[]\n}\n\nmodel Post {\n  id        Int      @id @default(autoincrement())\n  title     String\n  content   String?\n  published Boolean  @default(false)\n  authorId  Int\n  author    User     @relation(fields: [authorId], references: [id])\n  createdAt DateTime @default(now())\n  updatedAt DateTime @updatedAt\n}\n",
  "inlineSchemaHash": "c87e0ef03116e768a4c249dfb0a73d03c4bcb42fff44bc4acdca3f6a00c77ffb",
  "copyEngine": true,
  "runtimeDataModel": {
    "models": {},
    "enums": {},
